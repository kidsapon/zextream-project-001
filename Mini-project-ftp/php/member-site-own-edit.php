...
if (isset($_POST['update'])) {
    ...
    $sql = $updatedata->update($username, $password, $mem_fname, $mem_lname, $email, $mem_tel, $mem_born, $userid);

    if ($sql) {
        echo "<script>alert('Updated Successfully!');</script>";
        echo "<script>window.location.href='member-site-own.php'</script>";
    } else {
                ...
                <div class="app-header-right">
                    ...
                    <?php if (isset($_SESSION['username'])) : ?>
                        ...
                        <div class="widget-content-right header-user-info ml-3">
                            <p>
                                <a href="index.php?logout='1'" style="color: red;" class="mb-2 mr-2 btn-transition btn btn-outline-danger">
                                    <h4 class="widget-heading">Logout</h4>
                                </a>
                            </p>
                        </div>
                    <?php endif ?>
                        ...
                        <div class="col-12">
                            ...
                            <div class="content">
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="container">
                                        <h1 class="mt-5">หน้าแก้ไขข้อมูลสมาชิก</h1>
                                        <hr>
                                            ...
                                            <form action="" method="post">
                                                ...
                                                <div class="main-card mb-3 card">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="member_firstname" value="<?php echo $row['member_firstname']; ?>" required>
                                                    </div>
                                                </div>
                                                <div class="main-card mb-3 card">
                                                    <div class="mb-3">
                                                        <label for="member_lastname" class="form-label">Last name</label>
                                                        <input type="text" class="form-control" name="member_lastname" value="<?php echo $row['member_lastname']; ?>" required>
                                                    </div>
                                                </div>
                                                <div class="main-card mb-3 card">
                                                    <div class="mb-3">
                                                ...
                                                <div class="main-card mb-3 card">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="member_tel" value="<?php echo $row['member_tel']; ?>" required>
                                                    </div>
                                                </div>
                                                <div class="main-card mb-3 card">
                                                    <div class="mb-3">
                                                        <label for="member_born">วันเกิด</label>
                                                        <input type="date" class="form-control" name="member_born" value="<?php echo $row['member_born']; ?>" required>
                                                    </div>
                                                </div>
                                                <!-- <div class="mb-3">
                                                <label for="member_born">member_born</label>
                                                <textarea name="member_born" cols="30" rows="10" class="form-control" required><?php echo $row['member_born']; ?></textarea>
                                            </div> -->
                                            <?php } ?>
